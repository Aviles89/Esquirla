...
<div class="resp">
    <div class="respHead">
        <a href="index.html" title="">MERICARNES</a>
    </div>

    <div class="cLine"></div>
    <div class="smalldd">
        <span class="goTo"><img src="images/icons/light/home.png" alt="" />Menu</span>
        <ul class="smallDropdown">
            <li><a href="inicio" title=""><img src="images/icons/light/home.png" alt="" />Principal</a></li>
            <li><a href="reportes" title=""><img src="images/icons/light/stats.png" alt="" />Reportes</a></li>
            <li><a href="#" title="" class="exp"><img src="images/icons/light/pencil.png" alt="" />Ventas<strong>0</strong></a>
                <ul>
                    <li><a href="ventas" title="">Listado</a></li>
                    <li><a href="ventas/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="#" title=""><img src="images/icons/light/users.png" alt="" />Compras</a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="tables.html" title="" class="exp"><img src="images/icons/light/frames.png" alt="" />Clientes<strong>3</strong></a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="#" title="" class="exp"><img src="images/icons/light/fullscreen.png" alt="" />Proveedores<strong>2</strong></a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="#" title="" class="exp"><img src="images/icons/light/alert.png" alt="" />Facturas<strong>6</strong></a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="file_manager.html" title=""><img src="images/icons/light/files.png" alt="" />Prodcutos</a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="#" title="" class="exp"><img src="images/icons/light/create.png" alt="" />Precios<strong>3</strong></a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="#" title="" class="exp"><img src="images/icons/light/create.png" alt="" />Mermas<strong>3</strong></a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="#" title="" class="exp"><img src="images/icons/light/create.png" alt="" />Sucursales<strong>3</strong></a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="#" title="" class="exp"><img src="images/icons/light/create.png" alt="" />Vendedores<strong>3</strong></a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
            </li>
            <li><a href="#" title="" class="exp"><img src="images/icons/light/create.png" alt="" />Usuarios<strong>3</strong></a>
                <ul>
                    <li><a href="compras" title="">Listado</a></li>
                    <li><a href="compras/nuevo" title="">Nueva Venta</a></li>
                </ul>
        ...
        <div class="middleNav">
            <ul>
                <li class="mUser"><a title=""><span class="users"></span></a>
                    <ul class="mSub1">
                        <li><a href="#" title="">Nueva Venta</a></li>
                        <li><a href="#" title="">asdsadas</a></li>
...
<div class="statsRow">
    <div class="wrapper">
        <div class="controlB">
            <ul>
                <li><a href="#" title=""><img src="images/icons/control/32/plus.png" alt="" /><span>Nueva Venta</span></a></li>
                <li><a href="#" title=""><img src="images/icons/control/32/database.png" alt="" /><span>Nueva Compra</span></a></li>
                <li><a href="#" title=""><img src="images/icons/control/32/hire-me.png" alt="" /><span>Nuevo Cliente</span></a></li>
                <li><a href="#" title=""><img src="images/icons/control/32/statistics.png" alt="" /><span>Nuevo Proveedor</span></a></li>
                <li><a href="#" title=""><img src="images/icons/control/32/comment.png" alt="" /><span>Nueva Factura</span></a></li>
                <li><a href="#" title=""><img src="images/icons/control/32/order-149.png" alt="" /><span>Nuevo Producto</span></a></li>
            </ul>
            <div class="clear"></div>
        </div>
    </div>
...
<!-- Footer line -->
<div id="footer">
    <div class="wrapper">MERICARNES 2012 </div>
</div>
