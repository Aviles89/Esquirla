                        ...
                        <tr >
                            ...
                            <ul id="itemContainer" class="galleryView center" >
                                <li class="animated fadeInUp">
                                    <a href="../uploads/inicio/<?php echo $r->foto; ?>" rel="prettyPhoto" title="">
                                        <img src="../uploads/inicio/<?php echo $r->thumbnail; ?>" data-original="../uploads/inicio/<?php echo $r->thumbnail; ?>" alt="" style="display: inline;">
                                    </a>
                                </li>
                            </ul>
                            </td>
