        ...
        <div class="box">
            ...
            <div class="content">
                <form class="form-horizontal"
                      ...
                      autocomplete="off">
                    <?php //echo formInput('titulo','titulo','',$clase ='','*Título');?>
                    <?php //echo formInput('descripcion','descripcion','',$clase ='','Descripción');?>
					<?php echo formInput('link','link','',$clase ='','Enlace');?>					

                    <div class="form-row row-fluid">
                        <div class="span12">
                            <div class="row-fluid">

                                <label class="form-label span4" for="textarea">Foto (Tamaño de imágen 1170 x 450 px. Peso máximo 500KB)</label>
